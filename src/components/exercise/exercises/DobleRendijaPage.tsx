      ...
      context={
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4 backdrop-blur-md">
          ...
          <ul className="my-3 ml-4 list-disc space-y-2 text-sm text-slate-400">
            ...
            <li>
              <strong className="text-cyan-400">Pantalla (lado derecho):</strong> Es donde se proyecta el patrón de interferencia. En un experimento real verías múltiples franjas brillantes y oscuras alternadas, pero aquí representamos solo la posición de la franja brillante de orden <Formula math="m" /> que estás calculando.
            </li>
            <li>
              <strong className="text-cyan-400">Línea horizontal de color:</strong> Esta línea representa la <strong>posición exacta</strong> de la franja brillante de orden <Formula math="m" /> en la pantalla. El color de la línea corresponde a la longitud de onda <Formula math="\lambda" /> que calculaste: violeta/azul para longitudes cortas (~400 nm), verde para medias (~550 nm), rojo para largas (~700 nm).
            </li>
          </ul>

          <p className="text-sm leading-relaxed text-slate-400">
            <strong className="text-slate-300">¿Qué observar cuando modificás los parámetros?</strong> Al aumentar la distancia <Formula math="L" /> a la pantalla, la línea se mueve hacia arriba o abajo (mayor separación del centro). Al aumentar la separación <Formula math="d" /> entre rendijas, la línea se acerca al centro. Al cambiar el orden <Formula math="m" />, ves cómo se ubican las franjas de diferentes órdenes (primera, segunda, tercera, etc.). El color de la línea cambia según la longitud de onda calculada.
          </p>
